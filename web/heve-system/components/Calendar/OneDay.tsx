...
export default function OneDay({ day, index, onclickHandler, today, daylist, nowYear, nowMonth }: { day: string, index: number, onclickHandler: React.MouseEventHandler, today: string }) {
