...
export default function Card({ name, evaluation, medicine }: { name: string, evaluation: string, medicine: Array<Medicine> }) {
        ...
        show ? (
            <div className="flex flex-col gap-4 p-6 shadow-[0px_4px_24px_0px_rgba(0,0,0,0.25)] rounded-2xl">
                ...
                <div className="flex flex-col gap-[10px]">
                    ...
                    <p className="justify-self-stretch text-sm max-w-[550px]">食事に続けて、お菓子を食べ続けないでください。どうしても食べたいのであれば低血糖のお菓子をお食べください。</p>
                </div>
            </div >
        ) : (
            <div className={`flex flex-col gap-4 p-6 shadow-[0px_4px_24px_0px_rgba(0,0,0,0.25)] rounded-2xl ${shimmer}`}>
                ...
                <div className="flex flex-col gap-[10px]">
                    ...
                    <div className="justify-self-stretch text-sm min-w-[550px] max-w-[550px] bg-gray-200 h-4 rounded-full"></div>
                    <div className="justify-self-stretch text-sm min-w-[550px] max-w-[550px] bg-gray-200 h-4 rounded-full"></div>
                    <div className="justify-self-stretch text-sm min-w-[550px] max-w-[550px] bg-gray-200 h-4 rounded-full"></div>
                </div>
            </div >
