    ...
    return (
        <header className="flex flex-row justify-between items-center px-4 h-10 md:pr-7">
            ...
            <div className="md:hidden">
                <div id="hamburger" className="w-5 h-5 overflow-hidden flex flex-col gap-1" onClick={clickHandler}>
                ...
                {show &&
                    <div className="absolute bg-white rounded-lg shadow-xl right-4 px-4 py-4 flex flex-col gap-2">
                        <div className="flex flex-col px-2 py-1 border-b-2 border-[#EEEDED]">
                            <p className="text-sm">高本龍信</p>
                            <p className="text-sm">22歳</p>
                        </div>
                        <p className="font-bold hover:bg-[#E8E8E8] px-2 py-1 rounded-lg cursor-pointer" onClick={() => handleClick('Home')}>ホーム</p>
                        <p className="font-bold hover:bg-[#E8E8E8] px-2 py-1 rounded-lg cursor-pointer" onClick={() => handleClick('Chat')}>チャット</p>
                        <p className="font-bold hover:bg-[#E8E8E8] px-2 py-1 rounded-lg cursor-pointer" onClick={() => handleClick('Calendar')}>カレンダー</p>
            ...
            <div className="hidden md:flex flex-row gap-5 lg:gap-8">
                <b id="Home" className="rounded-full px-3 py-1 hover:bg-[#E8E8E8] text-center cursor-pointer" onClick={() => handleClick('Home')}>ホーム</b>
